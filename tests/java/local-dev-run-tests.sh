...
waitforit/wait-for-it.sh -t 0 -h 127.0.0.1 -p 9200
waitforit/wait-for-it.sh -t 0 -h 127.0.0.1 -p 8082

sleep 60

export API_APP_PORT=3000
export ELASTICSEARCH_ROOT=http://127.0.0.1:9200
export ZEBEDEE_ROOT=http://127.0.0.1:8082
...
waitforit/wait-for-it.sh -t 0 -h 127.0.0.1 -p 3000
